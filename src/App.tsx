...
import { AteliersPage } from "./pages/services/AteliersPage";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/services/ateliers" element={<ProtectedRoute><SubPageLayout><AteliersPage /></SubPageLayout></ProtectedRoute>} />
