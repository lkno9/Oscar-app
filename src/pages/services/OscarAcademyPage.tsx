import { ArrowLeft, GraduationCap, Play, CheckCircle, Clock, ChevronRight } from "lucide-react";
...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    description: "Rédigez des courriers officiels et suivez vos démarches en cours.",
    duration: "3 min",
    emoji: "📝",
    steps: [
      { title: "Ouvrir les démarches", content: "Depuis 'Mes Services', appuyez sur 'Démarches admin'." },
      { title: "Écrire un courrier", content: "Appuyez sur 'Écrire un courrier'. Choisissez un modèle (réclamation, résiliation, etc.) et répondez aux questions. Oscar rédige le courrier pour vous." },
      { title: "Modifier le texte", content: "Après génération, appuyez sur 'Modifier' pour ajuster le texte avant de l'envoyer ou le télécharger." },
      { title: "Suivre mes démarches", content: "Dans 'Mes démarches', retrouvez vos tâches en cours et marquez-les comme terminées." },
    ],
  },
  {
    id: "sos",
